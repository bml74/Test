...
class Transaction(models.Model):
    ...
    seller = models.ForeignKey(User, null=True, blank=True, related_name="seller", on_delete=models.DO_NOTHING)
    purchaser = models.ForeignKey(User, null=True, blank=True, related_name="purchaser", on_delete=models.DO_NOTHING)
    seller_verified = models.BooleanField(null=True, blank=True)
    purchaser_verified = models.BooleanField(null=True, blank=True)
