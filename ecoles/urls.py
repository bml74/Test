...
urlpatterns = [
    ...
    # path('modules/<int:pk>/', modules.ModuleDetailView.as_view(), name='module_detail'),
    ...
    # path('module/<int:module_id>/submodules/list/', submodules.SubmoduleListView.as_view(), name='submodules_list'),
    # path('module/<int:module_id>/submodules/new/', submodules.SubmoduleCreateView.as_view(), name='submodule_create'),
    # path('submodules/<int:pk>/', submodules.SubmoduleDetailView.as_view(), name='submodule_detail'),
    # path('module/<int:module_id>/submodules/update/<int:pk>/', submodules.SubmoduleUpdateView.as_view(), name='submodule_update'),
    # path('module/<int:module_id>/submodules/delete/<int:pk>/', submodules.SubmoduleDeleteView.as_view(), name='submodule_delete'),

    # path('submodule/<int:submodule_id>/assignments/list/', assignments.AssignmentListView.as_view(), name='assignments_list'),
    # path('submodule/<int:submodule_id>/assignments/new/', assignments.AssignmentCreateView.as_view(), name='assignment_create'),
    # path('assignments/<int:pk>/', assignments.AssignmentDetailView.as_view(), name='assignment_detail'),
    # path('submodule/<int:submodule_id>/assignments/update/<int:pk>/', assignments.AssignmentUpdateView.as_view(), name='assignment_update'),
    # path('submodule/<int:submodule_id>/assignments/delete/<int:pk>/', assignments.AssignmentDeleteView.as_view(), name='assignment_delete'),

    # path('assignment/<int:assignment_id>/tasks/list/', tasks.TaskListView.as_view(), name='tasks_list'),
    # path('assignment/<int:assignment_id>/tasks/new/', tasks.TaskCreateView.as_view(), name='task_create'),
    # path('tasks/<int:pk>/<str:username>/', tasks.TaskDetailView.as_view(), name='task_detail'),
    # path('assignment/<int:assignment_id>/tasks/update/<int:pk>/<str:username>/', tasks.TaskUpdateView.as_view(), name='task_update'),
    # path('assignment/<int:assignment_id>/tasks/delete/<int:pk>/<str:username>/', tasks.TaskDeleteView.as_view(), name='task_delete'),
